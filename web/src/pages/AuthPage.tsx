  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: 4 }}>
        ...
        >
          Контролируйте импульсивные покупки, планируйте бюджет и принимайте
            ...
            sx={{
              ...
              backgroundColor:
                backendStatus === "online"
                  ...
                  : "#FFD600",
              animation:
                backendStatus === "checking" ? "pulse 1.5s infinite" : "none",
            }}
          />
          ...
          {[
            {
              ...
              desc: "Откладывайте покупки на 1-90 дней",
            },
            {
              icon: "🚫",
              title: "Запрещённые категории",
              desc: "Блокировка импульсивных трат",
            },
            {
              icon: "💰",
              title: "Финансовый расчёт",
              desc: "Когда покупка станет комфортной",
            },
            {
              icon: "🤖",
              title: "ИИ-помощник",
              desc: "Консультации по покупкам",
            },
            {
              icon: "📊",
              title: "Аналитика",
              desc: "Отслеживание ваших привычек",
            },
            {
              icon: "🔔",
              title: "Умные уведомления",
              desc: "Напоминания о целях",
            },
          ].map((feature, index) => (
            <Paper
              key={index}
