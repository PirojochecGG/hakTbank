...
Revision ID: 0382eff2632d
Revises: 
Create Date: 2025-12-06 20:19:21.493026
...
def upgrade() -> None:
    ...
    sa.Column('sys_name', sa.String(length=100), nullable=False),
    ...
    with op.batch_alter_table('tariffs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_tariffs_sys_name'), ['sys_name'], unique=True)
    ...
    sa.Column('priority', sa.Enum('GENERAL', 'PREMIUM', name='requestpriority'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    with op.batch_alter_table('tariffs', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_tariffs_sys_name'))
