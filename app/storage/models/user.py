...
class User(Base):
    ...
    monthly_savings:  Mapped[int]           = mapped_column(Integer, default=0, doc="Сумма откладываемая в месяц (копейки)")
    monthly_salary:   Mapped[Optional[int]] = mapped_column(Integer, doc="Месячная зарплата (копейки)")
    current_savings:  Mapped[int]           = mapped_column(Integer, default=0, doc="Текущие накопления (копейки)")
